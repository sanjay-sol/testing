...
{/* <a className="text-black text-decoration-none  " href={link1} target="_blank" rel="noreferrer" >{item.substring(7)}</a> */}
  <p> <u> {item.substring(7)}</u>
  
  </p> 
  <div className="qr" >
   
    <img src={`https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://ipfs.io/ipfs/${item.substring(6)}`} download alt="img" />
  {/* {`https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://gateway.pinata.cloud/ipfs/${item.substring(6)}`} */}
